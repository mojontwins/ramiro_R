...
..\utils\map2bin.exe ..\map\mapa.map 6 4 99 ..\bin\map.bin ..\bin\bolts.bin twots
move ..\bin\map.bin.spt ..\script

echo ### MAKING ENEMS ###
..\utils\ene2bin.exe 6 4 1 ..\enems\enems.ene ..\bin\enems.bin ..\bin\hotspots.bin

echo ### MAKING TILESET ###
..\utils\ts2bin.exe ..\gfx\font.png ..\gfx\work.png ..\bin\ts.bin forcezero

echo ### MAKING SPRITESET ###
..\utils\sprcnv.exe ..\gfx\sprites.png sprites.h 16
...
echo ### MAKING TEXTS ###
cd ..\texts
..\utils\textstuffer2.exe texts.bin textfile=texts.txt mode=simple wordwrap=24 ramiro=25
copy texts.bin ..\bin\texts.bin
..\utils\textstuffer2.exe texts-eng.bin textfile=texts-eng.txt mode=simple wordwrap=24 ramiro=25
