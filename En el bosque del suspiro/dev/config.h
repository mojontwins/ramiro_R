...
#define SCR_INI					5		//  Initial screen
...
#define PATROLLERS_HIT			7 		// If defined, patrollers take THIS life, otherwise 1
...
#define FANTIES_HIT 			9 		// If defined, fanties take THIS life, otherwise 1
...
#define KILL_SLOWLY_GAUGE_X		17		// For evil zone counters
...
unsigned char behs [] = {
	0, 3, 3, 3, 3, 3, 8, 8, 8, 4, 8, 8, 4, 0, 8, 8,
	8, 0, 0, 0, 0, 0, 0, 0, 0, 8, 8, 8, 8, 0, 0, 8,
	0, 0, 8, 4, 1, 4, 8, 8, 8, 8, 0, 0, 4, 0, 0, 0
};
#endif
