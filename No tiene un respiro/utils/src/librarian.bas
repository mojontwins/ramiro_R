...
Print #fl, "}"
Print #fl, " "
Print #fl, "#ifdef NEED_RAMN_OFFSETS"
Print #fl, "int read_offset (unsigned char res, unsigned int offs) {"
Print #fl, "	ram_page [0] = resources [res].ramPage;"
Print #fl, "    ram_address [0] = (resources [res].ramOffset + offs);"
Print #fl, "    #asm"
Print #fl, "        di"
Print #fl, "        ld a, (_ram_page)"
Print #fl, "        ld b, a"
Print #fl, "        call SetRAMBank"
Print #fl, "        ld hl, (_ram_address)"
Print #fl, "        ld de, _asm_int"
Print #fl, "        ldi"
Print #fl, "        ldi"
Print #fl, "        ld b, 0"
Print #fl, "        call SetRAMBank"
